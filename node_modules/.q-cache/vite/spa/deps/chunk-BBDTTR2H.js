...
function useKeyPress(keyFilter, options) {
  const target = computed(() => {
    var _a;
    return (_a = toValue(options == null ? void 0 : options.target)) != null ? _a : defaultDoc;
  });
  ...
  onKeyStroke(
    ...
    (e) => {
      var _a2, _b2;
      var _a, _b;
      const actInsideInputWithModifier = (_a2 = toValue(options == null ? void 0 : options.actInsideInputWithModifier)) != null ? _a2 : true;
      const preventDefault = (_b2 = toValue(options == null ? void 0 : options.preventDefault)) != null ? _b2 : false;
  ...
  onKeyStroke(
    ...
    (e) => {
      var _a;
      const actInsideInputWithModifier = (_a = toValue(options == null ? void 0 : options.actInsideInputWithModifier)) != null ? _a : true;
      if (isPressed.value) {
        const preventAction = (!modifierPressed || modifierPressed && !actInsideInputWithModifier) && isInputDOMNode(e);
        if (preventAction) {
          return;
...
var _sfc_main$a = defineComponent({
  ...
  setup(__props) {
    ...
    function onPointerDown(event) {
      var _a2;
      var _a, _b, _c;
      containerBounds.value = (_a2 = (_a = vueFlowRef.value) == null ? void 0 : _a.getBoundingClientRect()) != null ? _a2 : null;
...
function useHandleConnections(params) {
  ...
  const currentNodeId = toRef(() => {
    var _a;
    return (_a = toValue(nodeId)) != null ? _a : _nodeId;
  });
  const handleType = toRef(() => toValue(type));
  const handleId = toRef(() => {
    var _a;
    return (_a = toValue(id2)) != null ? _a : null;
  });
...
function useNodeConnections(params = {}) {
  ...
  const lookupKey = computed(() => {
    var _a;
    const currNodeId = (_a = toValue(nodeId)) != null ? _a : _nodeId;
      ...
      if (!Array.isArray(edgeIds)) {
        ...
        if (edge) {
          return {
            id: edge.id,
            type: edge.type,
            data: (_a = edge.data) != null ? _a : null
          };
        }
        return null;
      }
      ...
      for (const edgeId of edgeIds) {
        ...
        if (edge) {
          data.push({
            id: edge.id,
            type: edge.type,
            data: (_b = edge.data) != null ? _b : null
          });
        }
      }
      return data;
...
//# sourceMappingURL=chunk-BBDTTR2H.js.map
